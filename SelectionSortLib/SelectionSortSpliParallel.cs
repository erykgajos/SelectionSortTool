...
{
    public class SelectionSortSplitParallel : ISelectionSort
    {
        List<int> numbers;
        List<int> half1;
        List<int> half2;
        ...
        public SelectionSortSplitParallel(List<int> numbers)
        {
        ...
        public double Sort()
        {
            ...
            for (int x = 0; x < Functions.NUMBER_OF_LOOPS; x++)
            {
                ...
                Thread thread1 = new Thread(SortPart1);
                Thread thread2 = new Thread(SortPart2);
